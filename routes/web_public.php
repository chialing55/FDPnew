...
Route::redirect('subjects/seedling', '/subjects/long-term-seedling-dynamics', 301);
Route::redirect('subjects/forest-regeneration', '/subjects/long-term-seedling-dynamics', 301);
Route::redirect('subjects/tree', '/subjects/long-term-tree-dynamics', 301);
...
Route::redirect('subjects/mortality', '/subjects/long-term-tree-dynamics', 301);
