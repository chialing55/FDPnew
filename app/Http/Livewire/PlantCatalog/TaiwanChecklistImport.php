...
class TaiwanChecklistImport extends Component
{
    ...
    private string $connection = 'plant_catalog';
        ...
        try {
            ...
            DB::connection($this->connection)->transaction(function () use ($rows, $headers, $importColumns, &$imported) {
                ...
                foreach (array_chunk($rows, 500) as $chunk) {
                    ...
                    TaiwanChecklist::query()->insert($payload);
    ...
    {
        return view('livewire.plant-catalog.taiwan-checklist-import');
    }
}
