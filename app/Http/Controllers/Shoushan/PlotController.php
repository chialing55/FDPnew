...
class PlotController extends Controller
{
    ...
    public function note1ha(Request $request)
    {
    ...
    public function note10m(Request $request)
    {
    ...
    //產生資料表
    public function entry1ha(Request $request)
    {
    ...
    public function entry10m(Request $request)
    {
    ...
    public function compare1ha(Request $request)
    {
    ...
    public function compare10m(Request $request)
    {
    ...
    public function dataviewer10m(Request $request)
    {
    ...
    public function dataviewer1ha(Request $request)
    {
    ...
    public function update10m(Request $request)
    {
    ...
    public function update1ha(Request $request)
    {
    ...
    public function map10m(Request $request)
    {
    ...
    public function map1ha(Request $request)
    {
