...
<div class='content'>
    ...
    <div class='flex' style='flex-wrap: wrap; justify-content: center; gap:20px; padding:30px;'>
        ...
        @php
            ...
            $workUi = [
                'fushan.tree' => ['img' => asset('/images/research/tree.png'), 'class' => 'box1', 'label' => '福山 每木'],
                'fushan.seeds' => ['img' => asset('/images/research/seed.png'), 'class' => 'box1', 'label' => '福山 種子雨'],
                'fushan.seedling' => ['img' => asset('/images/research/seedling.png'), 'class' => 'box1', 'label' => '福山 小苗'],
                'shoushan.plot' => ['img' => asset('/images/research/monkey.png'), 'class' => 'box2', 'label' => '壽山 植物監測'],
            ];
        @endphp
