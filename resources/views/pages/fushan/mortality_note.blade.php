...
@section('rightbox')
    ...
    <div>
        ...
        <div class='note'>
            ...
            <div class='text_outbox flex' style="flex-direction: column;">
                <div class='text_box_note_out'>
                    <div class='text_box text_box_note'>
                        <h2>基本操作</h2>
                        <ol>
                            <li>每次進入頁面後，先確認目前選擇的 map 是否正確，再開始輸入。</li>
                            <li><b>Date</b> 請填西元年月日，格式為 <b>YYYY-MM-DD</b>。
                            </li>
                            <li><b>Team</b> 請填 <b>team_id</b>。輸入時會檢查該 team_id 是否存在，且必須屬於本次 census。
                                <ul style="list-style-type:disc;">
                                    <li>若需查詢或建立團隊，請點選表格上方的<b>建立 / 查詢團隊</b>。</li>
                                    <li>可用 team_id 或人名搜尋，並可點選表頭排序。</li>
                                    <li>點選下方團隊清單中的 team_id 後，會載入該團隊人員。</li>
                                    <li>修改人員後，按<b>新增團隊</b>會建立新的團隊組合；按<b>儲存修改</b>才會修改原本載入的 team_id。</li>
                                    <li><b>清空欄位</b>只會清除上方團隊人員欄位，不會刪除資料庫中的團隊。</li>
                                    <li>若需刪除團隊，系統會先檢查是否為已使用的團隊，若為已使用則無法刪除。</li>
                                </ul>
                            </li>
                        ...
                        <ol>
                            ...
                            <li>連動規則
                                <ul style="list-style-type:disc;">
                                    ...
                                    <li><b>Status = A</b> 且 <b>Mode</b> 包含 <b>B</b> 時，必須填寫 <b>Living length</b>。若缺乏調查資料請填
                                        <b>-1</b>。
                                    </li>
                ...
                <div class='text_box_note_out'>
                        ...
                        <ol>
                            <li>DBH(new)
                                <ul style="list-style-type:disc;">
                                    ...
                                    <li><b>DBH(new)</b> 應大於等於 <b>DBH(old)</b>。若小於，需在備註中加入 <b>確認縮水</b> 或 <b>DBH shrink</b> 的
                                        option。</li>
                                </ul>
                            </li>
                            <li>Branches
                            ...
                            <li>Illumination
                                <ul style="list-style-type:disc;">
                                    ...
                                    <li><b>Status = A</b> 且 <b>DBH(new)</b> 空白時，若 <b>Illumination</b> 填了非 0 的值，則必須補填
                                        <b>DBH(new)</b>。
                                    </li>
                                </ul>
                            </li>
                            <li>例外規則
                                <ul style="list-style-type:disc;">
                                    <li><b>Status = A</b> 且 <b>Living length &lt; 1.3</b> 時，即使有填寫 <b>Branches</b> 或
                                        <b>Illumination</b>，也可不填 <b>DBH(new)</b>。
                                    </li>
                                </ul>
                            </li>
                        </ol>
                    ...
                    <div class='text_box text_box_note'>
                        ...
                        <ol>
                            ...
                            <li>樹幹與葉片
                                <ul style="list-style-type:disc;">
                                    <li><b>Wounded stem</b>、<b>Rotten</b>、<b>Deformity</b>、<b>Leaves</b>、<b>Leaf damage</b>
                                        只能在 <b>Status = A / OK</b> 時填寫。</li>
                        ...
                        <ol>
                            ...
                            <li>備註填寫
                                <ul style="list-style-type:disc;">
                                    ...
                                    <li>若只修改備註，也需要再按一次<button class='datasavebutton'
                                            style='width:auto'>儲存</button>，才會將表格內容一併寫回。</li>
                                </ul>
                            </li>
                        </ol>
