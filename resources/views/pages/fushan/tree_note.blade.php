...
<div class='flex text_outbox' style="flex-direction: column;">
    ...
    <div class='text_box text_box_note'>
        ...
        <li><b>dbh/h高</b> - 填入測量值至<span class='line'>小數點後一位</span>。
            <ul>
                ...
                <li>若此次調查植株縮水至 dbh < 1 cm，原dbh欄位仍填寫1，並另在特殊修改的 dbh(<1)欄位中填寫此次調查數值。</li>
                <li>若無法測量或因特殊因素沒有測量，填寫 999。</li>
    ...
    <div class='text_box text_box_note' >
        ...
        <li><b>只要有更新輸入資料，皆需按 <button class='finishbutton'>輸入完成</button> 已紀錄輸入完成。</b></li>
