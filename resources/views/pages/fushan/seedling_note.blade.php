        ...
        <ol>
            ...
            <li><b>狀態</b> - 記錄存活狀態，以<b>個體</b>為單位，分枝狀態需與主幹狀態相同。<span class='line'>預設為 <b>A</b> (存活)</span>。其他代碼: <b>G</b>: 見環不見苗，<b>D</b>: 死亡，<b>N</b>: 消失，<b>L</b>: 離開。
                <ul>
                    ...
                    <li>當主幹或萌糵的 DBH > 1 時，長度等欄位記錄 -2，狀態欄仍為 A (分支狀態需與主幹同)。但需在 note 欄標明 DBH > 1，並在特殊修改欄位註記 <span class='line'>狀態:A→L。(由後端修改)</span></li>
                    <li>若該個體只剩下 DBH > 1 的主幹，記錄 -2，萌糵及主幹的狀態欄改為 L，表示此苗已離開小苗調查的範圍。</li>
                </ul>
            </li>
...
<!--        <li><b>特殊情況說明</b> :<br>
    ...
    <hr>
        <ol>
            ...
            <li><b>萌櫱狀態</b> - 預設為 <b>False</b>，若為新增的萌櫱苗，請選為 <b>True</b>。</li>
