...
@elseif($item === 'distribution')
  ...
  <div style='margin-top:18px;'>
    <p style='margin:0 0 10px;'>
      圖2. 福山森林動態樣區 {{ $distributionSummary['start_month_text'] }} 至 {{ $distributionSummary['end_month_text'] }} 各植物之花朵和成熟果實及種子所分布之收集網數量。圖中黑色代表花朵、灰色代表成熟果實及種子。
    </p>
