<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __("Update your profile information and login account.") }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="account" name="account" type="text" class="mt-1 block w-full" :value="old('account', $user->account)" required autocomplete="username" />
