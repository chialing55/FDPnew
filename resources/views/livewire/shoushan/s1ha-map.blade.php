...
<div class="loading-container" wire:loading.class="visible">
    ...
    <div class='text_box'>
        ...
        @endphp
                    <span class='{{$prevshow}}'><a class='a_' wire:click.once="searchSite({{$qx}}, {{$qy-1}})">上一個樣方</a></span>
                    <span class='{{$nextshow}}'><a class='a_' wire:click.once="searchSite({{$qx}}, {{$qy+1}})">下一個樣方</a></span>
