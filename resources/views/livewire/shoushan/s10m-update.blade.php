        ...
        {{-- @include('includes.census5Progress') --}}
            <div style="margin-left:20px;">
                <form wire:submit.prevent="indStemid()">
                    <input name="tag" class="fs100" placeholder="plot" wire:model.defer="plot" style="width: 80px;">-<input name="tag" class="fs100" placeholder="tag" wire:model.defer="tag" style="width: 50px;">.<input name="branch" class="fs100" wire:model.defer="branch" placeholder="b" style="width: 30px;"> <span style="font-size: 80%;">*預設 b 為 0</span>
                    <button type="submit" style="margin-left: 20px;">GO</button>
                </form>
            </div>
        </div>
